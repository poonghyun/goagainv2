...
u5 = User.create(username: "Yusuf", password: "testing", fp_url: 'https://www.filepicker.io/api/file/FXuj2BpqTX6J7iLr4Gr4')
u6 = User.create(username: "Guest", password: "welcome")
u7 = User.create(username: "Ned", password: "testing", fp_url: 'https://www.filepicker.io/api/file/yGuMqopiR1SfmNSULbS3')
u8 = User.create(username: "Will", password: "testing")
u9 = User.create(username: "Jeff", password: "testing")
u10 = User.create(username: "CJ", password: "testing", fp_url: 'https://www.filepicker.io/api/file/Y64fu8SSbumFnrcXGZTo')
...
b7 = Business.create(name: "In-N-Out", b_type: "Restaurants", price: 1, x_coord: 37.807718, y_coord: -122.418551)
b8 = Business.create(name: "Giant Monkey Movers", b_type: "Home Services", price: 4, x_coord: 37.782897, y_coord: -122.41496)
b9 = Business.create(name: "Friendly Plumber", b_type: "Home Services", price: 1, x_coord: 37.772829, y_coord: -122.483263)
b10 = Business.create(name: "Happy Donut", b_type: "Bakeries", price: 1, x_coord: 37.791561, y_coord: -122.399799)
b11 = Business.create(name: "Little Sheep Hot Pot", b_type: "Restaurants", price: 3, x_coord: 37.787296, y_coord: -122.410178)
...
b21 = Business.create(name: "Yerba Buena Gardens", b_type: "Arts & Entertainment", price: 1, x_coord: 37.785094, y_coord: -122.40274)
...
b27 = Business.create(name: "LaLanne Fitness", b_type: "Gyms", price: 3, x_coord: 37.780706, y_coord: -122.406499)
